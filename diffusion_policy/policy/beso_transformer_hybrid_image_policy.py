...
class BesoTransformerHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            # task params
            horizon, 
        ...
        self.model = model
        # we need our wrapper again for the preconditioning of the diffusion model
    ...
    def conditional_sample(self, 
        ...
        sigma = self.get_noise_schedule(num_inference_steps, scheduler)
